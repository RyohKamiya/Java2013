...
public class ClockView extends Frame{
	...
	private int fontSize = 120;//defaultのフォントサイズ
	private String fontName = "Times New Roman";
	private Font f = new Font(fontName,fontStyle,fontSize);
	private MenuBar menuBar;
	private MenuFrame property;
	...
	public void createMainForm(){
		...
		property = new MenuFrame(this,"Property",true);
	}
	...
	private void recieveResizeEvent(){
		class MyComponentListener implements ComponentListener{
			...
			private void calcFontSize(int width, int height){
				...
				for(int i = 1; i < MenuFrame.SIZES.length; i++){
					Font tf = new Font(fontName,fontStyle,Integer.parseInt(MenuFrame.SIZES[i]));
					...
					optSize = Integer.parseInt(MenuFrame.SIZES[i]);
