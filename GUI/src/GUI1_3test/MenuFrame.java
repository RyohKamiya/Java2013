...
public class MenuFrame extends Dialog{
	...
	public MenuFrame(ClockView view, String title, boolean modal){
	...
	private void addItemsFontColor(){
		...
		class MyItemListener implements ItemListener{
			...
			public void itemStateChanged(ItemEvent arg0) {
				//　イベント発生時の処理
				fontColor = color[Arrays.binarySearch(strCrs, choiceFontColor.getSelectedItem())];
			}
		}
	...
	private void addItemsBackgroundColor(){
		...
		class MyItemListener implements ItemListener{
			...
			public void itemStateChanged(ItemEvent arg0) {
				//　イベント発生時の処理
				backgroundColor = color[Arrays.binarySearch(strCrs, choiceBackgroundColor.getSelectedItem())];
			}
		}
